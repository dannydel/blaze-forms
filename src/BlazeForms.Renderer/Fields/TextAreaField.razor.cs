...
/// <summary>
/// A multi-line free-text input (PRD §5, <see cref="Definitions.NodeType.TextArea"/>). Stores
/// its answer as <see cref="string"/>, or <see langword="null"/> when empty.
/// </summary>
/// <remarks>
...
public sealed partial class TextAreaField : FormFieldBase
{
