...
/// <summary>
/// A static highlighted notice (PRD §5, <see cref="Definitions.NodeType.Callout"/>). Carries no
/// answer, so it ignores every value/validation parameter on <see cref="FormFieldBase"/>.
