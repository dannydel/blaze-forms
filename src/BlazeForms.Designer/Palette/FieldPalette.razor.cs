...
/// P1 types; Advanced holds the schema-only <see cref="NodeType.Calc"/> plus every type
/// <see cref="FormSchema.IsReservedForLaterPhase"/> reports, so a future reserved type shows up
/// here, disabled, without a change to this file.
/// </summary>
/// <remarks>
...
public partial class FieldPalette : ComponentBase
{
    ...
    [
        ...
        new("PaletteGroupAdvanced", [NodeType.Calc, .. FormSchema.ReservedNodeTypes]),
    ];
    ...
    private IEnumerable<PaletteGroup> VisibleGroups => Groups
        .Select(group => new PaletteGroup(group.ResourceKey, [.. group.Types.Where(MatchesSearch)]))
