...
/// <see cref="NodeType.Email"/>: renders a <see cref="MudBlazor.MudTextField{T}"/> of
/// <see cref="string"/> constrained to <see cref="MudBlazor.InputType.Email"/> in place of the
/// shipped <see cref="EmailField"/>, wired through <see cref="MudFieldComponentRegistry"/> with
/// no change to <c>BlazeForms.Core</c> or <c>BlazeForms.Renderer</c>. Stores its answer as
...
public partial class EmailFieldAdapter : FormFieldBase
{
