...
/// <see cref="NodeType.Number"/>: renders a <see cref="MudBlazor.MudNumericField{T}"/> of
/// <see cref="decimal"/>? in place of the shipped <see cref="NumberField"/>, wired through
/// <see cref="MudFieldComponentRegistry"/> with no change to <c>BlazeForms.Core</c> or
/// <c>BlazeForms.Renderer</c>. Stores its answer as <see cref="decimal"/>?, or
/// <see langword="null"/> when empty, the same convention the shipped component follows.
/// </summary>
[SuppressMessage(
    "Design",
...
public partial class NumberFieldAdapter : FormFieldBase
{
