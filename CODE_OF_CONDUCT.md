...
requests, discussions, and any other BlazeForms project space), and also
...
contacting the repository owner ([@dannydel](https://github.com/dannydel)) directly on
GitHub. For conduct that also violates GitHub's own Community Guidelines, GitHub's
[report abuse](https://github.com/contact/report-abuse) flow is an additional avenue. All
complaints will be reviewed and investigated promptly and fairly.

Security vulnerabilities are a separate matter — see [SECURITY.md](SECURITY.md) for that
private reporting channel. Do not use GitHub Security Advisories to report a Code of
Conduct violation; that channel is for vulnerabilities, not conduct.
